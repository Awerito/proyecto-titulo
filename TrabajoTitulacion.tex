...
\begin{itemize}\justifying
    \item \textbf{Objetivo específico 1}: Recopilar y estructurar un conjunto de datos de imágenes de muestras para el entrenamiento y testeo del modelo de detección de parásitos.
  \item \textbf{Objetivo específico 2}: Definir un modelo de detección de parásitos para la automatización de resultados del examen parasitológico seriado de deposiciones basado en visión por computadora.
  \item \textbf{Objetivo específico 3}: Analizar y validar la calidad de las predicciones de la detección de parásitos en las muestras, a través de experimentación con el conjuntos de datos recopilado y con muestras obtenidas desde procedimientos reales del examen parasitológico seriado de deposiciones, utilizando imagenes microscopicas.
\end{itemize}
...
\section{Metodología}
A continuación se exponen las actividades a realizar para cumplir los distintos objetivos planteados en \ref{objetivos}.
%TODO Definir tareas a realizar para cada objetivo
