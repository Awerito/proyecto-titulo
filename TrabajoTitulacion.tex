...
% Hacer esto a mano no suple la demanda médica
    ...
    relacionados a la observación microscópica de muestras, estos exámenes son realizados
    bajo observación humana de manera totalmente manual. Normalmente los exámenes que
    involucran esta observación microscópica suelen demandar bastante tiempo por muestra,
...
% Certeza incierta
    ...
    introducido en las observaciones, resultando en observaciones con clasificaciones
    erróneas, esto concluyendo en el mal diagnostico médico. En ocasiones puede haber una
...
%TODO revisar
    Para la consultoría de este trabajo se cuenta con la ayuda del laboratorio clínico
    ...
    de las muestras por medio de observación microscópica, en la realización de la
    observación se documenta la confirmación y clasificación de presencia parasitológica
    en orden de dar con un tratamiento certero, eficaz y acorde a las detecciones.  La
    denominación seriado refiere a las condiciones en las que estas muestras, tres
...
% Inconsistencia en las mediciones / definición del problema
    ...
    Es por ello que se pretende utilizar tecnologías de visión por computadora para
