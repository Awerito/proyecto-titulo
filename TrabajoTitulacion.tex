...
\begin{enumerate}
    \item modelar la contingencia del estado del mundo en los datos $Pr(w|x)$ or
...
\subsection{Modelar contingencia de datos del mundo (Discriminativo)}
...
máxima verosimilitud (ML), máximo a posteriori (MAP), o enfoques bayesianos (capítulo
4).%cita acá
