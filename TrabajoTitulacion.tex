...
especialmente útil para reducir el arreglo de píxeles de valores rgb a un simple valor
...
\begin{figure}[H]
    ...
    \caption{Filtro con \textit{kernel} para resaltar contornos de objetos en la imagen.
        ...
        valor de píxeles en la imagen. Así obtenemos un mapa de características que en este
...
El modelo \textit{Faster RCNN Inception Resnet} \ref{tensorflowmodelgarden2020} es una red
...
misma imagen como se puede apreciar en la figura \ref{resnet}.
...
El modelo \textit{Centernet} \ref{zhou2019objects} de detección identifica los objetos como
...
Los resultados del modelo concluyen en un tiempo de espera por inferencia de $7.84$ segundos
con clasificaciones mostradas a continuación en \ref{fig:comparation_caca}.
